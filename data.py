M14_data = {
        ...
        'Mairie de Saint-Ouen': ['m:Region Île-de-France', ['M13']],
        'Gare de Saint-Ouen': [None, ['RC']],
        'Porte de Clichy': ['m:Tribunal de Paris', ['M13', 'T3b', 'RC']],
        'Pont Cardinet': ['m:Test Test Test test test Test', ['p:SL']],
        'Saint-Lazare': ['m:Gare Grandes Lignes', ['M3', 'M9', 'M12', 'M13', 'RA', 'RE', 'SJ', 'SL']],
        'Madeleine': [None, ['M8', 'M12']],
        'Pyramides': [None, ['M7']],
        'Châtelet': ['m:Test', ['M1', 'M4', 'M7', 'M11', 'RA', 'RB', 'RD']],
